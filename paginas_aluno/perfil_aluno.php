...
<?php
	...
	// Página com dados, e edição de perfil do aluno logado, reservada para alunos
	...
	$dados = alunos::where(['cod_aluno'=>$_SESSION['login']]);
	$id = $dados->value('id_aluno');
?>
...
<html lang="en">
	...
	<body id="perfil">
			...
			<div class="modal-dialog" role="document">
		    	<div class="modal-content">
		      		...
		      		<div class="modal-body">
		        		...
		        		<form action="../paginas_processos/editar.php?id=<?php echo $id; ?>&pg=aluno_perfil" method="POST">
			        		...
			        		<hr>
					       	<br>
					       	<input type="text" name="senha" placeholder="Senha" class="input_modal" maxlength="20" style="margin-right: 6%" value="<?php echo $dados->value('senha'); ?>">
		...
		<?php include "..\paginas_include\header_aluno.html"; ?>
		...
		<div class="d-none d-sm-block" style="margin: -60px 0 20px 0; text-align: center">
				...
				<table class="table">
					...
					<tbody>
						<?php
							...
							$saidas = saidas::where(['id_aluno'=>$id])->where(['_status'=>0])->orderBy('dias_atraso','desc')->get();
