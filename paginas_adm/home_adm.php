...
<html lang="en">
	...
	<body id="home">
		...
		<div class="conteudo d-none d-sm-block">
			...
			<div>
				<div class="notificacao rounded" style="background-color: #80bfff; float: left; margin-left: 70px;">
					Total de livros cadastrados : <span style="font-weight: bold"><?php echo count(itens::all()); ?></span>
					<hr>
					Total disponíveis no estoque : <span style="font-weight: bold"><?php echo count(itens::where(['_status'=>1])->get()); ?></span>
				</div>
				<div class="notificacao rounded" style="background-color: #80bfff; float: right; margin-right: 70px;">
					Total atualmente com alunos : <span style="font-weight: bold"><?php echo count(itens::where(['_status'=>0])->get()); ?></span>
					<hr>
					Total com devolução atrasada : <span style="font-weight: bold"><?php echo count(saidas::where(['_status'=>0])->where('dias_atraso','>',0)->get()); ?></span>
				</div>
				<br style="clear: left;">
			</div>
		...
		<div class="d-block d-sm-none">
				...
				<div style="width: 65%;display: inline-block; background-color: #80bfff;">Total de livros cadastrados</div>
				...
				<div style="width: 65%;display: inline-block; background-color: #80bfff;">Total disponíveis no estoque</div>
				...
				<div style="width: 65%;display: inline-block; background-color: #80bfff;">Total atualmente com alunos</div>
				...
				<div style="width: 65%;display: inline-block; background-color: #80bfff;">Total com devolução atrasada</div>
